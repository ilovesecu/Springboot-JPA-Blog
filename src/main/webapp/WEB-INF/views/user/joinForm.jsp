	...
	<main class="form-signin">
		...
		<form class="row g-3">
			...
			<div class="form-floating">
				<input type="text" class="form-control" id="userId" name="userId" placeholder="UserID"> <label for="userId">아아디</label>
			</div>
			<div class="form-floating">
			...
			<div class="form-floating">
				<input type="text" class="form-control" id="username" name="username" placeholder="Username"> <label for="email">이름</label>
			</div>
			<div class="form-floating">
				<input type="email" class="form-control" id="email" name="email" placeholder="Email"> <label for="email">이메일</label>
			</div>
			<button class="w-100 btn btn-lg btn-primary" type="submit">회원가입</button>
			<a href="/auth/loginForm" class="d-block mt-2">이미 아이디가 있으신가요?</a>
